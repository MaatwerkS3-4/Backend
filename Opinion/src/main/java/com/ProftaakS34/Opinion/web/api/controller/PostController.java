...
public class PostController {
    ...
    public PostDTO getPostBySubject(@PathVariable String subject){
        return turnPostIntoPostInfo(postService.findPostBySubject(subject));
    }

    @GetMapping("/partialString/{string}")
    public List<PostDTO> getPostsByPartialSubject(@PathVariable String string){
    ...
    private PostDTO turnPostIntoPostInfo(PostDAO postDAO) {
